...
const Nabvar = () => {
	...
	return (
		<>		
			 <div className={`nabvar ${!show? "hide-navbar":""} ${showmenu? "dark": ""}`}>
			...
			<div className="nav-container">
				...
				<div className="nav-toggole" onClick={()=>setShowmenu(!showmenu)}>{!showmenu?<i class="fa-solid fa-bars"></i>:<i class="fa-solid fa-x"></i>}</div>
			</div>
			</div>
			

			<div className={`mobile-menu ${!showmenu? "hide-mobile-menu": ""}`}>
				<ul>
					<li onClick={()=>navigate("/explore/movie")}>movies</li>
					<li onClick={()=>navigate("/explore/tv")}>tv show</li>
				</ul>
