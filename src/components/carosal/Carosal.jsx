	...
	return (
		...
		<Contentwraper>	
		 <div className="main-carosal-sec">	
				...
				<div className="carsal_scroll" style={{transform:`translateX(${scroll}px)`}}>

				{
					...
					data?.results?.map((cur_res)=>{
						...
						const rating=cur_res.vote_average.toFixed(1)
							...
							return(<div className="each-carosal" onClick={()=>navigate(`/${cur_res.media_type||end||mediaType}/${cur_res.id}`)}><div className="each-carosal-img">
									   <LazyLoadImage
										className="img1"
    									alt={"hello"}
									    effect="blur"
									  ...
									  <div className="carosal-content">
									  	<div className="carosal-title">{cur_res.title || cur_res.name}</div>
									  	<div className="date">
				...
				<div onClick={()=>carosalMove(-683.75)}className="left-carosal"><i class="fa-solid fa-circle-arrow-right"></i></div>
				<div onClick={()=>carosalMove(683.75)} className="right-carosal"><i class="fa-solid fa-circle-arrow-left"></i></div>
