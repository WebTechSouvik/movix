...
const Cast = ({data, loading}) => {
	...
	return (
		...
		{
			result.length>0 ? result.map((cur)=>{
				return(<div className="cast-item">
					<div className="cast-img"><img src={url+cur.profile_path} alt=""/></div>
					<div className="cast-name">{cur.original_name}</div>
					<div className="cast-charecter">{cur.character}</div>
				</div>
					)
			}): ""
		}
